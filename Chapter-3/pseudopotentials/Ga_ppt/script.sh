...
plt.title('Radial s-orbital wavefunction for Ga atom')
...
plt.title('Radial p-orbital wavefunction for Ga atom')
...
plt.title('valence electronic density for Ga atom')
...
plt.title('Pseudopotential for Ga atom')
...
plt.title('p-orbital logarithimic derivate Ga atom')
