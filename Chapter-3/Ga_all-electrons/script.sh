...
plt.title('Radial s-orbiital wavefunction for Ga atom using all-electrons calculation')
...
plt.title('Radial p-orbiital wavefunction for Ga atom using all-electrons calculation')
...
plt.title('Electronic Density for Ga atom')
...
plt.title('Spin electronic density for Ga atom')
